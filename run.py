...
# [+]-------------------------------------------[+]
#  | Creator : Hekal  		         |
#  | Github : https://github.com/HekalG75        |
...
def jam(): # Don't Remove Code !!!!
    try:
        ...
        banner()
        nomor = input(f"{W}[{R}?{W}] Masukkan Nomor Target ye {Y}:{G} ")
        while True: # Looping
...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}HekalG75           │ Version {R}:{G} 3.0{W}             │
  {W}│ Github{R}:{G}github.com/HekalG75 {W}│ {W}Your Ip {R}:{Y} {ip}   {W}│
...
# Copyright 08/07/23
# Made By Executed Team ❤️ With HekalG75
